...
primaryDocument:
  ...
  content: <按 references/content-operations-template.md 生成的完整 Markdown>
...
- 需要章节骨架时，读取 `references/content-operations-template.md`。
- 输出前做质量检查时，读取 `references/content-operations-quality-checklist.md`。
