...
use aster::providers::bedrock::BEDROCK_DEFAULT_MODEL;
...
use aster::providers::google::GOOGLE_DEFAULT_MODEL;
use aster::providers::litellm::LITELLM_DEFAULT_MODEL;
use aster::providers::ollama::OLLAMA_DEFAULT_MODEL;
