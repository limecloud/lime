...
export const AGENT_RUNTIME_COMMANDS = {
  ...
  listFileCheckpoints: "agent_runtime_list_file_checkpoints",
  getFileCheckpoint: "agent_runtime_get_file_checkpoint",
  diffFileCheckpoint: "agent_runtime_diff_file_checkpoint",
...
export const AGENT_RUNTIME_COMMAND_DESCRIPTORS = [
  ...
  {
    key: "listFileCheckpoints",
    command: AGENT_RUNTIME_COMMANDS.listFileCheckpoints,
    domain: "thread",
    requestType: "AgentRuntimeListFileCheckpointsRequest",
    responseType: "AgentRuntimeFileCheckpointListResult",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "getFileCheckpoint",
    command: AGENT_RUNTIME_COMMANDS.getFileCheckpoint,
    domain: "thread",
    requestType: "AgentRuntimeGetFileCheckpointRequest",
    responseType: "AgentRuntimeFileCheckpointDetail",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  {
    key: "diffFileCheckpoint",
    command: AGENT_RUNTIME_COMMANDS.diffFileCheckpoint,
    domain: "thread",
    requestType: "AgentRuntimeDiffFileCheckpointRequest",
    responseType: "AgentRuntimeFileCheckpointDiffResult",
    lifecycle: "current",
    mockStrategy: "bridge-only",
    docsSection: "agent-runtime.thread",
  },
  ...
  },
  {
    ...
    domain: "session",
    requestType: "{ sessionId: string; resumeSessionStartHooks?: boolean }",
