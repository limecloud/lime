      ...
      <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {detailView.planning.unmetRequirements.length ? (
              <span className="rounded-full border border-amber-200 bg-amber-50 px-2.5 py-1 text-[11px] font-medium text-amber-700">
                待补 {detailView.planning.unmetRequirements.length} 项
              </span>
            ) : null}
          </div>
        </div>
        ...
        <div className="rounded-[20px] border border-slate-200 bg-slate-50 p-3.5">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <span className="rounded-full border border-white bg-white px-2.5 py-1 text-[11px] font-medium text-slate-700">
              会拿到：{detailView.outputHint}
            </span>
            <span className="rounded-full border border-white bg-white px-2.5 py-1 text-[11px] font-medium text-slate-700">
              推进方式：{detailView.executionChainLabel}
            </span>
          </div>
        </div>
        <details
              ...
              <div className="rounded-[24px] border border-slate-200 bg-white p-4">
                ...
                {detailView.contextPlan ? (
                  <div className="mt-4 space-y-3">
                    <div className="grid gap-2 md:grid-cols-3">
                      <div className="rounded-[18px] border border-slate-200 bg-slate-50 px-3 py-2">
                        ...
                        <div className="mt-1 text-sm font-medium text-slate-800">
                          {detailView.contextPlan.activeLayers.length} 个
                        </div>
                      </div>
                      <div className="rounded-[18px] border border-slate-200 bg-slate-50 px-3 py-2">
                        <div className="text-[11px] font-medium text-slate-500">
                      ...
                      <div className="rounded-[18px] border border-slate-200 bg-slate-50 px-3 py-2">
                        ...
                        <div className="mt-1 line-clamp-1 text-sm font-medium text-slate-800">
                          {detailView.contextPlan.scopeLabel ?? "当前这轮"}
                        </div>
                      </div>
                    </div>
                    ...
                    <details className="group rounded-[20px] border border-slate-200 bg-slate-50">
                  ...
                  <>
                    <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      {detailView.projectPackPlan.primaryPart ? (
                        <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-medium text-slate-700">
                          主件：{detailView.projectPackPlan.primaryPart}
                        </span>
                      ) : null}
                    ...
                    {detailView.projectPackPlan.notes.length ? (
                      <details className="mt-3 group rounded-[18px] border border-slate-200 bg-slate-50">
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1.06fr)_minmax(320px,0.94fr)]">
          <div className="rounded-[24px] border border-slate-200 bg-white p-4">
            ...
            <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(220px,0.82fr)_minmax(0,1.18fr)]">
              ...
              <div className="rounded-[18px] border border-slate-200 bg-slate-50 p-3">
                ...
                <Textarea
                  ...
                  className="mt-2 min-h-[104px] rounded-[14px] border-slate-200 bg-white text-sm leading-6 shadow-none"
            ...
            <div className="mt-3 rounded-[18px] border border-slate-200 bg-slate-50 px-3 py-2.5">
              ...
              <div className="mt-1 line-clamp-2 text-sm leading-6 text-slate-700">
            ...
            <details className="mt-3 group rounded-[18px] border border-slate-200 bg-slate-50">
              ...
              <div className="border-t border-slate-200 bg-white px-3 py-3 text-sm leading-6 text-slate-700">
                {detailView.launchSeedPreview}
              </div>
            </details>
            ...
            <div className="mt-4 border-t border-slate-100 pt-4">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex flex-wrap items-center justify-end gap-2">
                  ...
                  >
                    {savingContextBaseline ? "保存中…" : "记住带入"}
                  </Button>
                  <Button
                    type="button"
                    data-testid="sceneapp-page-launch"
                    className={cn(
                      "rounded-full bg-slate-900 px-5 text-white shadow-sm shadow-slate-950/15 hover:bg-slate-800",
                    )}
