    ...
    <section className="rounded-[24px] border border-slate-200/80 bg-white p-4 shadow-sm shadow-slate-950/5">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <span className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700">
          来源：{runDetailView.sourceLabel}
        </span>
        <span className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700">
          已回流结果：{runDetailView.artifactCount} 份
        </span>
        <span className="rounded-full border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700">
          用时：{runDetailView.durationLabel}
        </span>
      </div>
        ...
        <div className="border-t border-slate-200 bg-white px-3 py-3">
          <div className="flex flex-wrap gap-2 text-xs font-medium text-slate-700">
            <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1">
              记录：{runDetailView.runId}
            </span>
            <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1">
              开始：{runDetailView.startedAtLabel}
            </span>
            <span className="rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1">
              结束：{runDetailView.finishedAtLabel}
            </span>
          </div>
        </div>
      </details>
      ...
      <div className="mt-4 rounded-[20px] border border-slate-200 bg-slate-50 p-4">
        ...
        runDetailView.contextBaseline ? (
          <details
            ...
            className="group mt-4 rounded-[18px] border border-slate-200 bg-white"
          >
            <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3">
              ...
              <span className="hidden rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-[11px] font-medium text-slate-600 group-open:inline-flex">
                收起
              </span>
            </summary>
                ...
                <div className="mt-4 rounded-[18px] border border-sky-200 bg-sky-50/50 p-3">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2 text-sm text-slate-700">
                    ...
                    {runDetailView.contextBaseline.scopeLabel ? (
                      <div className="rounded-full border border-white bg-white px-2.5 py-1">
                  ...
                  {runDetailView.contextBaseline.referenceItems.length ? (
                    <details className="group mt-3 rounded-[16px] border border-white bg-white">
                      <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2">
      ...
      <details
        ...
        className="group mt-4 rounded-[20px] border border-slate-200 bg-white"
      >
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-4 py-3">
          <div>
