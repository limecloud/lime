...
export const BuiltinCommandBadge: React.FC<BuiltinCommandBadgeProps> = ({
  ...
  <div
    data-testid="inputbar-builtin-command-badge"
    className="mx-1 mt-1 flex w-fit items-center gap-1.5 rounded-md bg-sky-500/10 px-2 py-1.5 text-xs font-medium text-sky-700"
  >
