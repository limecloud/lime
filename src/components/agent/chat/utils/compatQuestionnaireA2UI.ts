...
export function buildCompatQuestionnaireA2UI(
  content: string,
): A2UIResponse | null {
...
export function formatCompatQuestionnaireSubmission(
  response: A2UIResponse,
  formData: A2UIFormData,
): string | null {
  return (
    buildCompatQuestionnaireSubmissionPayload(response, formData)
      ?.formattedMessage || null
  );
}

export function buildCompatQuestionnaireSubmissionPayload(
  response: A2UIResponse,
  formData: A2UIFormData,
