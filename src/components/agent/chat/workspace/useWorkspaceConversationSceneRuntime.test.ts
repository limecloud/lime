...
function createBaseParams(overrides: Record<string, unknown> = {}) {
  ...
  return {
    ...
    shellChromeRuntime: {
      ...
      shouldHideThemeWorkbenchInputForTheme: false,
      shouldRenderInlineA2UI: false,
    },
    themeWorkbenchHarnessDialog: undefined,
    ...
    browserAssistEntryLabel: undefined,
    ...
    handlePermissionResponseWithBrowserPreflight: noop,
